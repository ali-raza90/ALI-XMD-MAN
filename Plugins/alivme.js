  ...
  async (dest, zk, commandeOptions) => {
    ...
    try {
      ...
      await zk.sendMessage(dest, {
        ...
        contextInfo: {
          externalAdReply: {
            title: `💦 MESSAGE FROM: ${contactName}\n🦄𝐀𝐋𝐈-𝐗𝐌𝐃 𝐀𝐋𝐈𝐕𝐄🔥`, // Your contact in WhatsApp status format
            ...
            showAdAttribution: false, // Attribution for the channel
          },
  ...
  async (dest, zk, commandeOptions) => {
    ...
    try {
      ...
      await zk.sendMessage(dest, {
        ...
        contextInfo: {
          externalAdReply: {
            title: `🌟 MESSAGE FROM: ${contactName}\n🔥 ALI MD ALIVE 🔥`, // Your contact in WhatsApp status format
            body: "Yoh don't disturb am active🥱 Tap here",
            thumbnailUrl: smallThumbnailUrl, // Small thumbnail displayed below
            mediaType: 1, // Indicate this is an image
            renderLargerThumbnail: true, // Ensure thumbnail is displayed in full
