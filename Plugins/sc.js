...
zokou({ nomCom: "cc", categorie: "My Contact" }, async (dest, zk, commandeOptions) => {
...
❂━━━════──➳──════━━━❂`;
   ...
   if (lien.match(/\.(mp4|gif)$/i)) {
    try {
        zk.sendMessage(dest, { video: { url: lien }, caption:infoMsg + menuMsg, footer: "I am *Lucky Md*, Developed By Fredie Sir" , gifPlayback : false }, { quoted: ms });
    }
    catch (e) {
