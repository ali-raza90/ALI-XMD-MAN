...
const {
  ...
  let _0x3f6faa;
  try {
    _0x3f6faa = await _0x4375b2.profilePictureUrl(_0x24f18e, "image")["catch"](() => "https://cdn.ironman.my.id/q/BXTKN.jpg");
  } catch (_0x6d1bf4) {
    _0x3f6faa = "https://cdn.ironman.my.id/q/BXTKN.jpg";
  }
...
zokou({
  ...
  await _0xb269b7("*ALI_XMD is sending this message to all groups you are in*...");
  for (let _0x398282 of _0x115598) {
    let _0x25a35f = "‼️‼️𝐀𝐋𝐈_𝐗𝐌𝐃 𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓️‼️️‼️\n\n❗*message* : " + _0x1360fc + "\n\n️‼️ *Author*: " + _0x271224;
...
zokou({
  ...
  _0x298913("All pending participants have been approved to join by ALI-XMD.");
});
...
zokou({
  ...
  try {
    ...
    await _0x2e5b52("A moment, *ALI-XMD* is compiling " + _0x267c2d.length + " contacts into a vcf...");
